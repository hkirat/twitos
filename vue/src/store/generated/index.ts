...
import HkiratTwitosHkiratTwitosTwitos from './hkirat/twitos/hkirat.twitos.twitos'
...
export default { 
  ...
  HkiratTwitosHkiratTwitosTwitos: load(HkiratTwitosHkiratTwitosTwitos, 'hkirat.twitos.twitos'),
